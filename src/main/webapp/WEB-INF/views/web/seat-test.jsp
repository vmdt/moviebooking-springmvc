					...
					<div class="movie-detail">
						<table class="info">
							<tbody>
								<tr>
									<td><img
										src="https://ocwckgy6c1obj.vcdn.cloud/media/catalog/product/cache/1/thumbnail/dc33889b0f8b5da88052ef70de32f1cb/7/0/700x1000_13_1_.jpg"
										alt="NGƯỜI VỢ CUỐI CÙNG"></td>
									<td>
					...
					<div class="movie-detail">
						<form>
							...
							<input type="hidden" id="selectedSeats" name="selectedSeats"
								value="">
							<button type="submit" class="booking-button">Book</button>
						</form>
					</div>
	...
	<script>
		$(document).ready(function() {
		    ...
		    $(".booking-button").click(function(event) {
		        ...
		        var ids = $("#selectedSeats").val().split(",");
		        var data = {
		        		userId: 1,
		        		totalPrice: 0,
		        		ids
